...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-slate-50">
      <section className="container siteWidth flex gap-6 flex-col md:flex-row md:justify-between items-center  py-6 md:py-4">
        <div
        ...
        <div className="social flex md:flex-row flex-col justify-center items-center gap-2">
          ...
          <div className="icons flex justify-center items-center gap-3 md:gap-1">
            <Link
              ...
              className="text-5xl md:text-3xl text-upwork-normal hover:text-upwork-hover duration-300"
            >
              <FaSquareUpwork />
            </Link>
            <Link
              href="https://www.facebook.com/NesarAhmedRazon"
              className="text-5xl md:text-3xl text-facebook-700 hover:text-facebook-600 duration-300"
            >
              <FaFacebookSquare />
            </Link>
            <Link
              href="https://github.com/NesarAhmedRazon/"
              className="text-5xl md:text-3xl text-github-900 hover:text-github-700 duration-300"
            >
              <FaSquareGithub />
            </Link>
          </div>
